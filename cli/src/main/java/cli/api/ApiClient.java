...
public class ApiClient {
    ...
    public void getAggregatedResults(Filters filters, String output) {
        String url;
        HttpURLConnection conn;

        try {
            switch (output == null || output.isEmpty() ? "default" : output) {
                case "default":
                ...
                default:
                    System.out.println("Invalid output format: " + output);
            }
        } catch (IOException e) {
