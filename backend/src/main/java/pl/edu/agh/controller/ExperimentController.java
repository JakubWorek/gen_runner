...
public class ExperimentController {
    ...
    public ResponseEntity<?> deleteExperiment(@PathVariable("id") String idStr) {
        ...
        DeleteResult deleteResult = experimentService.deleteExperiment(id);

        ResponseEntity.status(deleteResult.status());
        if (deleteResult.ok()) {
    ...
    public ResponseEntity<?> deleteExperimentsGroup(@PathVariable("groupName") String groupName){
        DeleteResult deleteResult = experimentService.deleteExperimentsGroup(groupName);
